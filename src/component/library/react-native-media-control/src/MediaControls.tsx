...
const MediaControls = (props: Props) => {
  ...
  return (
    <TouchableWithoutFeedback accessible={false} onPress={toggleControls}>
      <Animated.View
        style={[styles.container, customContainerStyle, {opacity: 1}]}>
        <>
          ...
          <View style={styles.vLike}>
            ...
            <TouchableOpacity style={styles.toLike}>
              <Image source={APP_IMAGES.ic_comment} style={styles.iLike} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.toLike}>
              <Image source={APP_IMAGES.ic_share_posts} style={styles.iLike} />
            </TouchableOpacity>
          </View>
